    ...
    <div class="x_content">
        <form class="form-horizontal form-label-left input_mask" role="form">
            <div class="form-group">
                <div class="col-md-3 col-sm-3 col-xs-12 form-group">
                    ...
                    <input type="hidden" id="search_child_ruleId" name="search_child_ruleId" required="required" value="${param.ruleId}" class="form-control col-md-7 col-xs-12">
                    <input type="hidden" id="search_child_parent" name="search_child_parent" required="required" value="${param.parent}" class="form-control col-md-7 col-xs-12">
                </div>
                <div class="col-md-3 col-sm-3 col-xs-12 form-group">
      ...
      <div class="form-inline pull-left">
        <div class="form-group" style="margin-left: 5px;">
          ...
          <button type="button" class="btn btn-info" id="child_add">新增列表配置</button>
...
<script>
   var table=$('#child_table').bootstrapTable({
        url: '${ctx}/client/crawlerNode/search',
   ...
   $("#child_add").click(function () {
       ...
       window.ajaxDialog({
           ...
           width:"600px",
           height:"500px",
           url:"${ctx}/crawlerNode/addCrawlerNode.jsp?level=1&parent="+parent+"&ruleId="+ruleId
       });
   });
      ...
      if(ids==''){
          ...
          confirm({
              ...
              ok:function () {
                  $.ajax({
                      type: 'POST',
                      url: '${ctx}/client/crawlerNode/batchRemoveCrawlerNode',
                      data: {ids:ids},
                      dataType:"json",
   ...
   function editCrawlerNode(id) {
       window.ajaxDialog({
           ...
           width:"600px",
           height:"500px",
           url:"${ctx}/crawlerNode/updateCrawlerNode.jsp?id="+id
       });
   }
   //删除关键词
   function removeCrawlerNode(id) {
       confirm({
           ...
           ok:function () {
               $.ajax({
                   type: 'POST',
                   url: '${ctx}/client/crawlerNode/removeCrawlerNodeById',
                   data: {id:id},
                   dataType:"json",
                   success: function (result) {
                       if(result.status=="0"){
