        ...
        <form class="form-horizontal form-label-left input_mask" role="form">
            <div class="form-group">
                <div class="col-md-3 col-sm-3 col-xs-12 form-group">
                    ...
                    <input type="hidden" id="search_parent_ruleId" name="search_parent_ruleId" required="required" value="${param.ruleId}" class="form-control col-md-7 col-xs-12">
                </div>
                <div class="col-md-3 col-sm-3 col-xs-12 form-group">
...
<script>
   ...
   $("#parent_add").click(function () {
       ...
       window.ajaxDialog({
           ...
           width:"600px",
           height:"500px",
           url:"${ctx}/crawlerNode/addCrawlerNode.jsp?level=0&parent=0&ruleId="+ruleId
       });
   });
   ...
   function getCrawlerNode(id) {
       var ruleId=$("#search_parent_ruleId").val();
       tabLoadContent("node2","${ctx}/crawlerNode/childList.jsp?parent="+id+"&ruleId="+ruleId);
